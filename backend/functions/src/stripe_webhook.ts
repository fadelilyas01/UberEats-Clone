...
async function handlePaymentSuccess(paymentIntent: StripeEvent['data']['object']) {
    ...
    const fcmToken = restaurantDoc.data()?.fcm_token;
...
async function handlePaymentFailure(paymentIntent: StripeEvent['data']['object']) {
...
async function handleRefund(chargeObject: StripeEvent['data']['object']) {
